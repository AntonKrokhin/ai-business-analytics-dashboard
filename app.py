...
st.markdown("Upload a sales CSV file for analytics and an AI-generated report.")
st.divider()

uploaded_file = st.file_uploader(
    "Choose a CSV file (e.g. BigQuery export)",
    type=["csv"],
)
...
with st.expander("📋 Data Preview (5 rows)"):
...
if generate_clicked:
    ...
    with st.spinner("AI is analyzing metrics..."):
        try:
            ...
            st.error(f"⚠️ Groq API error: {exc}")
